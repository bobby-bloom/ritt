...
class AppTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xFF575aea),
      surfaceTint: Color(0xFF575aea),
      onPrimary: Color(0xFFFFFFFF),
      primaryContainer: Color(0xFFa7aaff),
      onPrimaryContainer: Color(0xFF2f32c2),
      secondary: Color(0xFFff824d),
      onSecondary: Color(0xFF000000),
      secondaryContainer: Color(0xFFffd29d),
      onSecondaryContainer: Color(0xFFd75a25),
      tertiary: Color(0xFFd84e13),
      onTertiary: Color(0xFFFFFFFF),
      tertiaryContainer: Color(0xFFff9e63),
      onTertiaryContainer: Color(0xFFb02600),
      ...
      inversePrimary: Color(0xFF4346d6),
      primaryFixed: Color(0xFFa7aaff),
      onPrimaryFixed: Color(0xFF1b1eae),
      primaryFixedDim: Color(0xFF9396ff),
      onPrimaryFixedVariant: Color(0xFF4346d6),
      secondaryFixed: Color(0xFFffd29d),
      onSecondaryFixed: Color(0xFFc34611),
      secondaryFixedDim: Color(0xFFffbe89),
      onSecondaryFixedVariant: Color(0xFFeb6e39),
      tertiaryFixed: Color(0xFFff9e63),
      onTertiaryFixed: Color(0xFF9c1200),
      tertiaryFixedDim: Color(0xFFff8a4f),
      onTertiaryFixedVariant: Color(0xFFc43a00),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xFF4346d6),
      surfaceTint: Color(0xFF4346d6),
      onPrimary: Color(0xFFFFFFFF),
      primaryContainer: Color(0xFF1b1eae),
      onPrimaryContainer: Color(0xFFFFFFFF),
      secondary: Color(0xFFeb6e39),
      onSecondary: Color(0xFF000000),
      secondaryContainer: Color(0xFFc34611),
      onSecondaryContainer: Color(0xFFFFFFFF),
      tertiary: Color(0xFFc43a00),
      onTertiary: Color(0xFFFFFFFF),
      tertiaryContainer: Color(0xFF9c1200),
      ...
      inversePrimary: Color(0xFF575aea),
      primaryFixed: Color(0xFFa7aaff),
      onPrimaryFixed: Color(0xFF1b1eae),
      primaryFixedDim: Color(0xFF9396ff),
      onPrimaryFixedVariant: Color(0xFF4346d6),
